...
- Release-bound: review security impact before tagging any release that changes `.github/workflows/release.yml`, `scripts/install.sh`, `skills/openplanner/SKILL.md`, SQLite migrations, runner write/update/delete behavior, iCalendar import/export, or release verification docs.
